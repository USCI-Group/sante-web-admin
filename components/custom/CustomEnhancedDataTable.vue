...
const emit = defineEmits(['viewAll', 'toggleFilters', 'emptyStateAction', 'rowDoubleClick'])
...
const pagination = ref({
    pageIndex: 0,
    pageSize: 10
    //pageIndex: props.currentPage ? props.currentPage - 1 : 0,
...
const table = useVueTable({
    ...
    onPaginationChange: (updater: ((old: any) => any) | any) => {
...
<template>
    <div>
        <!-- Table Toolbar -->
        <div class="flex flex-col lg:flex-row items-start lg:items-center gap-4 py-4" v-if="!disableToolbar">
            <!-- Search Input -->
            ...
            <div class="flex items-center gap-2 w-full lg:w-auto lg:ml-auto">
                ...
                <!-- Action Buttons -->
                <div v-if="!disableFilters" class="flex items-center gap-2">
            ...
            <div class="flex items-center space-x-6 lg:space-x-8">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <Button variant="outline" class="h-8 w-8 p-0" :disabled="!table.getCanPreviousPage()"
                        @click="
                            table.previousPage();
                            /* $emit('pageChange', table.getState().pagination.pageIndex + 1); */
                        ">
                    ...
                    <Button variant="outline" class="hidden h-8 w-8 p-0 lg:flex" :disabled="!table.getCanNextPage()"
                        @click="
                            ...
                            /* $emit('pageChange', table.getPageCount()); */
                        ">
